...
def gallery_image_upload_path(instance, filename):
    ...
    return f'users/{instance.pet_memorial.user.id}/petmemorial/{instance.pet_memorial.id}/gallery/{uuid.uuid4()}{ext}'
...
class PetMemorialGalleryImage(models.Model):
    ...
    image = models.ImageField(upload_to=gallery_image_upload_path, null=True, blank=True)
